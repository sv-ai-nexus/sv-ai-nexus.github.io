...
> Want to share these voices?
Use this link
&ndash; <a href="{{ page.url }}">{{ site.url }}{{ site.baseurl }}{{ page.url }}</a> &ndash;
to do it!

Heartfelt reflections from attendees of Silicon Valley AI Nexus's first official forum, [**"The Silicon Stethoscope: Bridging Korea's Medical Reality and Silicon Valley's AI Vision in Healthcare's Trillion-Dollar Transformation" (25-Jun-2026)**](/event-announcements/01).
...
> "I was really impressed by last month's seminar hosted by AI Nexus. My background is in AI data and evaluation, and I'm excited to deepen my expertise and connect with this community. Looking forward to meeting you all in person again soon."
>
> &mdash; H, AI Data & Evaluation

<!--
> — **Hannah Heejeong Lim**, AI Data & Evaluation
-->
...
<!--
> — **Esther KIM (김선민)**, UCSF Health Data Science 석사과정
-->
...
> "I learned about the Nexus through my first event last week which I found out through Luma directly. I have been fascinated about the full stack of hardware industry that exists in Korea for a long time now, and really looking forward to how that shapes physical AI there."
>
> &mdash; R, AI Systems Engineer, Med Tech Startup

-->

<!--
> — **Rahul Rana**, AI Systems Engineer, Med Tech Startup
-->
...
<!--
> — **이진희**, Stanford 정신과 방문학자, 디지털 멘탈헬스 연구
-->
